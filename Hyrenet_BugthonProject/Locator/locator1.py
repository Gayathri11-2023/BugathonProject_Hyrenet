...
class WebLocators:
    ...
    createTestLocator = '//*[@id="create-drive"]'
    testname_locator = '//*[@id="drive-name"]'
    testPeriod_locator = 'drive-dates'
    usethistocreateLocator = '//*[@id="use-this-to-drive"]'
    testPeriod_datechoosen_locator = '/html/body/div[2]/div[2]/div[1]/table/tbody/tr[3]/td[7]'
    testdescription_locator = '//*[@id="create-drive-page-two"]/div/div[2]/div/div/div[2]/div/div[2]/div/div/div/div[1]/div[2]/div/p'
