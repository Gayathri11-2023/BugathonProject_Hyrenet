...
class Testcreate:
    ...
    def test_createTest(self, boot):
        ...
        try:
            ...
            sleep(3)
            locator1.WebLocators().clickbutton_by_xpath(self.driver, locator1.WebLocators().usethistocreateLocator)
            sleep(3)
            ...
            sleep(2)
            locator1.WebLocators().clickbutton(self.driver, locator1.WebLocators().testPeriod_datechoosen_locator)
            sleep(2)

            locator1.WebLocators().entertext(self.driver, locator1.WebLocators().testdescription_locator,
